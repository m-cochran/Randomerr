...
// Save cart items to localStorage before navigating to the checkout page
const saveCartToLocalStorage = () => {
    localStorage.setItem('cartItems', JSON.stringify(cartItems));
};

// Call this function when the user clicks on the "Proceed to Checkout" button
document.querySelector('.checkout-button').addEventListener('click', saveCartToLocalStorage);
...
// Call the displayCartItems function when the checkout page loads
...
document.getElementById('checkout-form').addEventListener('submit', (e) => {
    ...
    // For simplicity, log the form data
    console.log('Form Data:', Object.fromEntries(formData.entries()));

    // Display a confirmation message (this can be replaced with actual payment processing)
